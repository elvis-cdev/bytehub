...
const WHATSAPP_NUMBER = ""; // TODO: add number, e.g. "254712345678" (no + or spaces)
        ...
        <div className="flex flex-col items-center gap-6 sm:flex-row sm:items-start sm:justify-between">
          ...
          <div className="flex flex-col items-center gap-3 sm:items-end">
            ...
            <div className="flex items-center gap-4">
                ...
                href="https://instagram.com/bytehubkenya"
                target="_blank"
                rel="noopener noreferrer"
                aria-label="ByteHub Kenya on Instagram"
                className="text-muted-foreground transition-colors hover:text-primary"
              >
                <FaInstagram size={22} />
              </a>
              
                href="mailto:bytehubkenya@gmail.com"
                aria-label="Email ByteHub Kenya"
                className="text-muted-foreground transition-colors hover:text-primary"
              >
                <Mail size={22} />
              </a>
              {WHATSAPP_NUMBER ? (
                  ...
                  target="_blank"
                  rel="noopener noreferrer"
                  aria-label="Message ByteHub Kenya on WhatsApp"
                  className="text-muted-foreground transition-colors hover:text-primary"
                >
                  <FaWhatsapp size={22} />
                </a>
